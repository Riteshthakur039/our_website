...
import layer1 from '../assets/layer8.png';
import layer2 from '../assets/layer7.png';
  ...
  return (
    ...
    <div className="bg-white min-h-screen flex flex-col md:flex-row justify-between items-center px-4 md:px-20">
      <div className="text-center md:text-left">
        ...
        On-demand Real<br/>Estate App
        </h1>
        <h1 className='mt-4 text-sm md:text-base lg:text-lg'>
        Grow your Real Estate business with a customized app that carries your brand and offers the experience of the leading app in the industry.
        </h1>
