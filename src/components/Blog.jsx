...
const Blog = () => {
  return (
    <>
      <section className="bg-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px] m-4">
    ...
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-10 w-full">
          ...
          <div>
            {date && (
              <span className="mb-5 inline-block rounded bg-blue-400 px-4 py-1 text-center text-xs font-semibold leading-loose text-black">
                {date}
              </span>
            )}
            <h3>
